...
const MyFriends = ["Ayesha", "Noor", "Fatima"];
...
const names = ["Ali", "Babar", "Charlie", "Danish"];
function printPersonalizedMessage(name) {
...
const motorcycles = ["Honda", "Yamaha", "Kawasaki", "Ducati", "Harley-Davidson"];
function printTransportationStatements(transport) {
...
const guests = ["Arslan", "Nadeem", "Zainab"];
function sendDinnerInvitation(name) {
...
let guestlist = ["Laraib", "Maria", "Nooram"];
function sendDinnerInvitations(name) {
    console.log(`Dear ${name},\nYou are invited to join me for dinner. It would be an honor to have your presence.\nLooking forward to meeting you!\nBest regards,\n[Your Name]`);
}
...
let guestslist = ["Alisha", "Moiz", "Neelum"];
function SendDinnerInvitation(name) {
    console.log(`Dear ${name},\nYou are invited to join me for dinner. It would be an honor to have your presence.\nLooking forward to meeting you!\nBest regards,\n[Your Name]`);
}
function Initialinvitations() {
...
let Guests = ['Ahmad', 'Zain', 'Ali', 'Danish'];
...
let Guest = ['Ali', 'Babar', 'Zain', 'Danish'];
console.log("Original guest list:");
console.log(guests);
...
function Car(manufacturer, model, ...info) {
    let car = {
